	...
	<div class="tab">
		...
		<div id="#tab2">
			<div class="wrap">
				...
				<a href="#" class="ui-button">enviar</a>
			</div>
		</div>
		<div id="#tab3">
			<div class="wrap">
...
<div style="background-color: #e7e7e7; margin-left: 325px;">
	<div style="background-color: #e7e7e7; height: 64px; border: 1px solid #a1a1a1">
		<span style="display: inline-block; padding: 5px; color: #FFAE00; margin: 15px;" class="ui-fnt-big">Estilos</span>
	...
	<div style="padding:10px;">onde estamos</div>
</div>
